...
export default function Home() {
  return (
    <>
      <div className="container mx-auto px-5 mt-[7%] max-w-[1200px]">
        <p className="py-1 px-5 rounded-full flex items-center w-fit gap-1 bg-[#09E37D]/16 text-[#088046] dark:text-[#12C971]">
          <FaCircle className="text-[10px]" />
          Available For Work
        </p>

        <h1 className="text-4xl font-bold dark:text-white text-[#111111] mt-10">
        ...
        <div className="flex flex-col sm:flex-row sm:justify-start gap-5 mt-10 w-full">
          ...
          <button className="w-full sm:w-auto justify-center cursor-pointer flex items-center gap-2 border-2 py-2 px-6 text-lg border-[#AEB1B7] rounded-md">
