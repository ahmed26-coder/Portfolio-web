...
const ProjectCard = React.memo(({ project }) => {
  ...
  return (
    <div className="group relative bg-white/80 dark:bg-gray-800/90 backdrop-blur-sm rounded-xl overflow-hidden shadow-lg transition-all duration-300 hover:shadow-2xl md:flex md:h-75 w-full">
      ...
      <div className="relative h-50 md:h-full md:w-3/5 overflow-hidden">
        <Image
      ...
      <div className="p-6 md:w-full flex flex-col justify-between relative z-10">
        <div>
          ...
          <p className=" hidden sm:block text-gray-600 dark:text-gray-300 mb-4 text-lg font-medium">
            {project.description}
          </p>
        </div>
